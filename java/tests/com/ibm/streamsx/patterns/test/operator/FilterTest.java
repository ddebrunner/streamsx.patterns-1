...
public class FilterTest {
    ...
    public void testSingleOutput() throws Exception {
        ...
        for (int t = 0; t < 10; t++) {
            ...
            OperatorInvocation<FilterTestOp> tf = jot
                    .singleOp(FilterTestOp.class);
            ...
            for (int i = 0; i < 100; i++) {
                ...
                if (value >= threshold) {
                    ...
                    assertEquals(value, lastPassTuple.getMostRecentTuple()
                            .getInt("a"));
                    assertEquals("v" + value, lastPassTuple
        ...
        for (int t = 0; t < 10; t++) {
            ...
            for (int i = 0; i < 100; i++) {
                ...
                if (value >= threshold) {
                    ...
                    assertEquals(value, lastNotPassTuple.getMostRecentTuple()
                            .getInt("a"));
                    assertEquals("v" + value, lastNotPassTuple
                            .getMostRecentTuple().getString("b"));
    ...
    public void testNonMatchingPassPort() throws Exception {
        testNonMatchingPorts(jot, FilterTestOp.class);
    }
